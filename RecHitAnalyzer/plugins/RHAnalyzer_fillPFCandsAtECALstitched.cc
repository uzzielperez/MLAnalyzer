...
void RecHitAnalyzer::branchesPFCandsAtECALstitched ( TTree* tree, edm::Service<TFileService> &fs ) {
  ...
  hEvt_EE_EndtracksQPt[0] = new TH2F("evt_EEm_EndtracksQPt", "QPt(i#phi,i#eta);i#phi;i#eta",
				     EB_IPHI_MAX, -TMath::Pi(), TMath::Pi(),
				     5*(HBHE_IETA_MAX_HE-1-HBHE_IETA_MAX_EB), eta_bins_EEm );
  hEvt_EE_EndtracksQPt[1] = new TH2F("evt_EEp_EndtracksQPt", "QPt(i#phi,i#eta);i#phi;i#eta",
				     EB_IPHI_MAX, -TMath::Pi(), TMath::Pi(),
				     5*(HBHE_IETA_MAX_HE-1-HBHE_IETA_MAX_EB), eta_bins_EEp );
  ...
  hEvt_EE_muonsQPt[0] = new TH2F("evt_EEm_muonsQPt", "QPt(i#phi,i#eta);i#phi;i#eta",
				 EB_IPHI_MAX, -TMath::Pi(), TMath::Pi(),
				 5*(HBHE_IETA_MAX_HE-1-HBHE_IETA_MAX_EB), eta_bins_EEm );
  hEvt_EE_muonsQPt[1] = new TH2F("evt_EEp_muonsQPt", "QPt(i#phi,i#eta);i#phi;i#eta",
				 EB_IPHI_MAX, -TMath::Pi(), TMath::Pi(),
				 5*(HBHE_IETA_MAX_HE-1-HBHE_IETA_MAX_EB), eta_bins_EEp );
...
void fillPFCandsAtECAL_with_EEproj ( TH2F *hEvt_EE_EndtracksPt_, TH2F *hEvt_EE_EndtracksQPt_, TH2F *hEvt_EE_muonsPt_, TH2F *hEvt_EE_muonsQPt_, int ieta_global_offset, int ieta_signed_offset ) {

  int ieta_global_, ieta_signed_;
  int ieta_, iphi_, idx_;
  float EndtrackPt_, EndtrackQPt_;
  float muonPt_, muonQPt_;
...
void RecHitAnalyzer::fillPFCandsAtECALstitched ( const edm::Event& iEvent, const edm::EventSetup& iSetup ) {
  ...
  for ( int iz(0); iz < nEE; ++iz ) hEvt_EE_EndtracksQPt[iz]->Reset();
  for ( int iz(0); iz < nEE; ++iz ) hEvt_EE_muonsPt[iz]->Reset();
  for ( int iz(0); iz < nEE; ++iz ) hEvt_EE_muonsQPt[iz]->Reset();
  ...
  fillPFCandsAtECAL_with_EEproj( hEvt_EE_EndtracksPt[0], hEvt_EE_EndtracksQPt[0], hEvt_EE_muonsPt[0], hEvt_EE_muonsQPt[0], ieta_global_offset, ieta_signed_offset );
  ...
  fillPFCandsAtECAL_with_EEproj( hEvt_EE_EndtracksPt[1], hEvt_EE_EndtracksQPt[1], hEvt_EE_muonsPt[1], hEvt_EE_muonsQPt[1], ieta_global_offset, ieta_signed_offset );
