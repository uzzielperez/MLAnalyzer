...
for j,decay in enumerate(decays):
  ...
  for ijet in [0]:
    ...
    #file_out_str = "%s/%s_IMGjet_RH%d_n%dk_label%d.hdf5"%(eosDir,decay,int(scale[0]),neff//1000,label)
    #file_out_str = "%s/%s_IMG_RH%d_n%dk_label%d.hdf5"%(eosDir,decay,int(scale[0]),neff//1000,label)
    file_out_str = "/uscms/home/mba2012/eos/IMG/%s_IMG_RH%d_n%dk_label%d.hdf5"%(decay,int(scale[0]),neff//1000,label)
